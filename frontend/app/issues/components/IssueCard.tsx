...
const IssueCard = forwardRef<HTMLDivElement, IssueCardProps>(
  ({ issue, onSave, onSkip, swipeDirection }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={`
          w-full max-w-md mx-auto card-shadow gradient-border animate-scale-in h-[420px] flex flex-col bg-gray-900 border-gray-800
